...
public partial class PokerSelector
{
    private void RegisterEvent()
    {
        ...
        // 注册对选择变更事件的监听
        ContextAwareExtensions.RegisterEvent<PokerSelectorSelectChangedEvent>(this, e =>
        {
            OnSelectChangedEvent(e.Poker,e.IsSelected);
        }).UnRegisterWhenNodeExitTree(this);
        
        // 注册对预览变更事件的监听
        ContextAwareExtensions.RegisterEvent<PokerSelectorReservesChangedEvent>(this, e =>
        {
            OnReservesChangedEvent(e.Poker,e.IsSelected);
        }).UnRegisterWhenNodeExitTree(this);
        
        // 注册对模式变更事件的监听
        ContextAwareExtensions.RegisterEvent<PokerSelectorModeChangedEvent>(this, e =>
        {
    ...
    private void OnSelectChangedEvent(IPoker poker,bool isSelected)
    {
        ...
        if (isSelected)
        {
            ...
            if (Reserves.Contains(poker))
            {
                ...
                ContextAwareExtensions.SendEvent(this, new PokerReserveResultChangedEvent
                {
                    NumValue = "666",
                    IsHidden = false,
                    Poker = poker
